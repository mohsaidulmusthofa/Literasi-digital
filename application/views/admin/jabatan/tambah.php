                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            <input name="jabatan" id="jabatan" type="text" class="form-control border-dark small mb-3" placeholder="Masukkan jabatan di perusahaan anda ..." aria-describedby="basic-addon2" value="<?= set_value('jabatan'); ?>">
                                        </div>
