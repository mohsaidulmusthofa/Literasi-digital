                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group">
                                            <textarea name="deskripsi" id="deskripsi" type="text" class="form-control border-dark small mb-3" placeholder="Masukkan Deskripsi Produk ..." aria-describedby="basic-addon2"><?= $produk[0]->DESKRIPSI ?></textarea>
                                        </div>
